...
export class OpCode<T extends OpCodeNames = OpCodeNames> {
    ...
    getDescription(): Description[] {
        ...
        result.push(["opCode", this.parsedInstruction.opCode, HalfWord.SIZE])
        ...
        ;(registers as ParsedRegister<T>[keyof ParsedRegister<T>][]).map(
            (name, index) => {
                result.push([name.toString(), bytes[index], Byte.SIZE])
            }
        )

        const [, word] = Instruction.asWords(this.instruction)
        if (rest !== undefined) {
            result.push([rest, word, Word.SIZE])
        }
...
export type Description = [string, string | number, number]
...
export const opDefinitions = {
    ...
    MoveRegisterAddress: {
        ...
        registers: ["register"],
        types: {
            registers: { register: "stub" },
            rest: { source_address: "stub" },
        },
        rest: "source_address",
    },
    /**
    ...
    MovePointerSourceOffset: {
        ...
        registers: ["pointer", "source"],
        types: {
            registers: { pointer: "stub", source: "stub" },
            rest: { immediate: "stub" },
        },
        rest: "immediate",
    },
    ...
    MoveTargetPointerOffset: {
        ...
        registers: ["target", "pointer"],
        types: {
            registers: { target: "stub", pointer: "stub" },
            rest: { immediate: "stub" },
        },
        rest: "immediate",
    },
    ...
    AddTargetLhsRhs: {
        ...
        types: {
            registers: { target: "stub", lhs: "stub", rhs: "stub" },
            rest: {},
        },
    },
    /**
    ...
    MultiplyHighLowLhsRhs: {
        ...
        types: {
            registers: { high: "stub", low: "stub", lhs: "stub", rhs: "stub" },
            rest: {},
        },
    },
    /**
    ...
    AddTargetSourceImmediate: {
        ...
        registers: ["target", "source"],
        types: {
            registers: { target: "stub", source: "stub" },
            rest: { immediate: "stub" },
        },
        rest: "immediate",
    },
...
export const opMap: OpMap = {
    0: "MoveRegisterImmediate",
